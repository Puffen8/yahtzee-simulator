...
class Strategy(ABC):
    ...
    @abstractmethod
    def should_finish_turn(self, dice: Dice, roll_number: int, scorecard: Scorecard) -> bool:
        """
        Decide whether to stop rolling and score this turn.
        """

    @abstractmethod
    def choose_dice_to_keep(self, dice: Dice, roll_number: int, scorecard: Scorecard) -> tuple[int]:
        """
